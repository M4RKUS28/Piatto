...
class Recipe(Base):
    ...
    important_notes = Column(Text, nullable=True, default="No special notes provided.")
    cooking_overview = Column(Text, nullable=True, default="Follow the instructions sequentially to complete the recipe.")
    ...
    suggested_collection = Column(String(255), nullable=True)  # AI-suggested collection for this recipe
