                                        ...
                                        <div className="relative">
                                                ...
                                                <input
                                                        ...
                                                        onChange={async (event) => {
                                                                ...
                                                                if (!file) return;
                                                                if (!user?.id) {
                                                                        setValidationError('You must be logged in to analyze an image');
                                                                        return;
                                                                }
                                                                setValidationError('');
                                                                setAnalyzing(true);
                                                                try {
                                                                        ...
                                                                        if (
                                                                                ...
                                                                                setValidationError('Image analysis did not return ingredients');
                                                                        }
                                                                } catch {
                                                                        setValidationError('Image analysis failed. Please try again.');
                                                                } finally {
                                                                        setAnalyzing(false);
                                                                }
                                                        }}
                                                ...
                                                {showPopup && (
                                                        <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 bg-[#FF9B7B] text-white px-4 py-2 rounded shadow-lg z-10 animate-fade-in">
                                                                No ingredients detected in image.
                                                        </div>
                                                )}
                                        </div>
                                </div>
